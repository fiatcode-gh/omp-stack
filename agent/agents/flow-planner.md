...
Do not manufacture length. Prefer decision-complete task briefs with exact paths/symbols/commands over explanatory prose. If a material product/architecture decision is not settled by the governing contract, stop planning that part and report the decision needed instead of inventing it.
